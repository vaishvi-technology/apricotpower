    ...
    <section class="inner-banner">
        <div class="container">
            <div class="inner-banner-head">
                <h1><span class="normal-font">SET NEW</span> <span class="bold-font">PASSWORD</span></h1>
            </div>
        </div>
    </section>
                    ...
                    <div class="auth-card">
                        <div class="auth-card-body">
                            ...
                            <form wire:submit.prevent="resetPassword">
                                ...
                                @error('email')
                                    <div class="error-text mb-3">{{ $message }}</div>
                                @enderror

                                <button type="submit" class="btn auth-btn w-100 mb-3" wire:loading.attr="disabled">
                                    <span wire:loading wire:target="resetPassword" class="auth-loading"></span>
